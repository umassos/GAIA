...
# Lowest Carbon Window (Oracle)
python3 src/run.py --scheduling-policy carbon --carbon-policy oracle -w 6x24

# Carbon Saving per Waiting Time
python3 src/run.py --scheduling-policy carbon --carbon-policy cst_average -w 6x24

# Carbon Saving per Waiting Time (Oracle)
python3 src/run.py --scheduling-policy carbon --carbon-policy cst_oracle -w 6x24
